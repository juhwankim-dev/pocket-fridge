...
![image_1](C:/Users/hoony/Desktop/exec/images/image_1.png)
...
![image_2](C:/Users/hoony/Desktop/exec/images/image_2.png)
...
![image_3](C:/Users/hoony/Desktop/exec/images/image_3.png)

![image_4](C:/Users/hoony/Desktop/exec/images/image_4.png)

![image_5](C:/Users/hoony/Desktop/exec/images/image_5.png)
...
![image_6](C:/Users/hoony/Desktop/exec/images/image_6.png)
...
![image_7](C:/Users/hoony/Desktop/exec/images/image_7.png)

![image_8](C:/Users/hoony/Desktop/exec/images/image_8.png)
...
![image_9](C:/Users/hoony/Desktop/exec/images/image_9.png)
...
![image_10](C:/Users/hoony/Desktop/exec/images/image_10.png)
...
![image_11](C:/Users/hoony/Desktop/exec/images/image_11.png)
...
![image_12](C:/Users/hoony/Desktop/exec/images/image_12.png)

![image_13](C:/Users/hoony/Desktop/exec/images/image_13.png)
...
![image_14](C:/Users/hoony/Desktop/exec/images/image_14.png)
...
![image_15](C:/Users/hoony/Desktop/exec/images/image_15.png)

![image_16](C:/Users/hoony/Desktop/exec/images/image_16.png)

### 7. 외부 접속 확인

![image_17](C:/Users/hoony/Desktop/exec/images/image_17.png)
...
![image_18](C:/Users/hoony/Desktop/exec/images/image_18.png)
...
![image_19](C:/Users/hoony/Desktop/exec/images/image_19.png)

![image_20](C:/Users/hoony/Desktop/exec/images/image_20.png)

![image_21](C:/Users/hoony/Desktop/exec/images/image_21.png)
...
- 위와 같이 Permission denied가 발생한다면 Docker 데몬 소켓파일(docker.sock)의 권한 변경이 필요
  ...
  ![image_22](C:/Users/hoony/Desktop/exec/images/image_22.png)
...
![image_23](C:/Users/hoony/Desktop/exec/images/image_23.png)
...
![image_24](C:/Users/hoony/Desktop/exec/images/image_24.png)
...
![image_25](C:/Users/hoony/Desktop/exec/images/image_25.png)

![image_26](C:/Users/hoony/Desktop/exec/images/image_26.png)

### 4. Jenkins 초기 설정

![image_27](C:/Users/hoony/Desktop/exec/images/image_27.png)

- Install suggested plugins 선택

![image_28](C:/Users/hoony/Desktop/exec/images/image_28.png)

- 정보 입력 후 Next

![image_29](C:/Users/hoony/Desktop/exec/images/image_29.png)

- Jenkins 도메인 주소 확인 후 Next

![image_30](C:/Users/hoony/Desktop/exec/images/image_30.png)
...
![image_31](C:/Users/hoony/Desktop/exec/images/image_31.png)

![image_32](C:/Users/hoony/Desktop/exec/images/image_32.png)
...
1. SSH Plugin 설치(Jekins 관리 → 플러그인 관리 → 설치 가능)
   ...
   ![image_33](C:/Users/hoony/Desktop/exec/images/image_33.png)

2. Key 파일 지정(Jenkins 관리 → 시스템 설정 → Publish over SSH 설정)

   - Key 입력 칸에 EC2 Pem 파일, 즉 K6D206T.Pem 파일 내용을 복사 / 붙여넣기 해준다.

     ![image_34](C:/Users/hoony/Desktop/exec/images/image_34.png)

3. SSH Server 추가 버튼 클릭 후 설정

   ![image_35](C:/Users/hoony/Desktop/exec/images/image_35.png)
...
1. Gitlab 플러그인 설치(Jenkins 관리 → 플러그인 관리 → 설치 가능)
   ...
   ![image_36](C:/Users/hoony/Desktop/exec/images/image_36.png)

2. Gitlab 설정(Jenkins 관리 → 시스템 설정 → Gitlab 설정)

   ![image_37](C:/Users/hoony/Desktop/exec/images/image_37.png)
   ...
   - Credentials 설정(Add 버튼 클릭)
     ...
     ![image_38](C:/Users/hoony/Desktop/exec/images/image_38.png)
     ...
     1. Credentials 설정
        ...
        ![image_39](C:/Users/hoony/Desktop/exec/images/image_39.png)
   ...
   ![image_40](C:/Users/hoony/Desktop/exec/images/image_40.png)
   ...
   - 만든 프로젝트 → 구성 → 소스 코드 관리
     ...
     ![image_41](C:/Users/hoony/Desktop/exec/images/image_41.png)

     - Repository URL : Gitlab Repository URL 주소

     - Credentials

       ![image_42](C:/Users/hoony/Desktop/exec/images/image_42.png)
   ...
   - 빌드 유발
     ...
     ![image_43](C:/Users/hoony/Desktop/exec/images/image_43.png)

     - Build when a change ... 체크

     ![image_44](C:/Users/hoony/Desktop/exec/images/image_44.png)

     - 빌드 유발 하단의 고급 버튼 클릭

     ![image_45](C:/Users/hoony/Desktop/exec/images/image_45.png)
     ...
     - Gitlab → setting → Webhooks
       ...
       ![image_46](C:/Users/hoony/Desktop/exec/images/image_46.png)
   ...
   - Build
     ...
     ![image_47](C:/Users/hoony/Desktop/exec/images/image_47.png)
   ...
   - 빌드 후 조치
     ...
     ![image_48](C:/Users/hoony/Desktop/exec/images/image_48.png)

     ![image_49](C:/Users/hoony/Desktop/exec/images/image_49.png)
   ...
   - Shell Script
     ...
     - init_spring_server.sh
       ...
       ![image_50](C:/Users/hoony/Desktop/exec/images/image_50.png)
     ...
     - init_flask_server.sh
       ...
       ![image_51](C:/Users/hoony/Desktop/exec/images/image_51.png)
...
![image_52](C:/Users/hoony/Desktop/exec/images/image_52.png)
...
- ERD 다이어그램
  ...
  ![image_53](C:/Users/hoony/Desktop/exec/images/image_53.png)
...
![image-20220520103132735](C:/Users/hoony/Desktop/exec/images/ymlsetting1.png)
...
![image-20220520103622054](C:/Users/hoony/Desktop/exec/images/googlemail1.png)



- 로그인 > Google 계정 관리 > 보안 > 앱 비밀번호 > 메일, Windows 컴퓨터 선택

![image-20220520103704991](C:\Git\S06P31D206\exec\images\googlemail2.png)

- 앱 비밀번호 생성

![image-20220520103740356](C:/Users/hoony/Desktop/exec/images/googlemail3.png)



- IMAP 사용 설정

![image-20220520104007711](C:/Users/hoony/Desktop/exec/images/googlemail4.png)



- yml 설정

![image-20220520103300558](C:/Users/hoony/Desktop/exec/images/ymlsetting2.png)
...
![image-20220520104647941](C:/Users/hoony/Desktop/exec/images/oauth1.png)

> API 및 서비스 클릭



![image-20220520104741516](C:/Users/hoony/Desktop/exec/images/oauth2.png)

> 사용자 인증 정보 클릭 후 프로젝트 만들기 클릭



![image-20220520104923865](C:/Users/hoony/Desktop/exec/images/oauth3.png)
...
![image-20220520105012071](C:/Users/hoony/Desktop/exec/images/oauth4.png)

> Google 계정이 있는 모든 사용자가 접근이 가능하게 할 것이기 때문에 외부 선택 후 만들기 클릭

![image-20220520105042922](C:\Git\S06P31D206\exec\images\oauth5.png)

> 앱 이름과 사용자 지원 이메일 작성후 저장 후 계속 버튼 클릭



![image-20220520105107370](C:/Users/hoony/Desktop/exec/images/oauth6.png)

> email / profile / openid 클릭 후 업데이트 버튼 클릭 후 저장 후 계속



![image-20220520105146624](C:/Users/hoony/Desktop/exec/images/oauth7.png)

> 저장 후 계속 버튼 클릭



![image-20220520105252655](C:/Users/hoony/Desktop/exec/images/oauth8.png)

> OAuth 클라이언트 ID 클릭



![image-20220520105318867](C:/Users/hoony/Desktop/exec/images/oauth9.png)

> 이름 URI입력 후 저장



![image-20220520105356190](C:/Users/hoony/Desktop/exec/images/oauth10.png)
...
![image-20220520105513456](C:/Users/hoony/Desktop/exec/images/oauth11.png)
...
![image-20220520110619012](C:/Users/hoony/Desktop/exec/images/fb1.png)



- 톱니바퀴 클릭 → 프로젝트 설정

![image-20220520110647402](C:/Users/hoony/Desktop/exec/images/fb2.png)



- 서비스 계정 클릭 → 자바 체크 → 새 비공개 키 생성

![image-20220520110713160](C:/Users/hoony/Desktop/exec/images/fb3.png)
...
![image-20220520110756662](C:/Users/hoony/Desktop/exec/images/fb4.png)

- yml 설정

![image-20220520111014953](C:/Users/hoony/Desktop/exec/images/fb5.png)
...
![image-20220520105932463](C:/Users/hoony/Desktop/exec/images/mattermost.png)



### IntelliJ에서 프로젝트 빌드

![image_54](C:/Users/hoony/Desktop/exec/images/image_54.png)
...
![image_55](C:/Users/hoony/Desktop/exec/images/image_55.png)

- Build가 완료되었다면 main을 실행시키기 위해 AndbackApplication을 열어준다.



![image_56](C:/Users/hoony/Desktop/exec/images/image_56.png)
