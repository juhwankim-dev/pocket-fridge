...
class IngreCheckerTest {
    ...
    fun setUp() {
        ...
        now = cal.time
        futurePurchased = Ingredient(-1, 1, "2022-05-01", "2022-05-10", "가지", 1, Storage.Fridge, 9)
        pastPurchased = Ingredient(-1, 1, "2022-01-01", "2022-05-10", "가지", 1, Storage.Fridge, 9)
        wrongExpiryDate = Ingredient(-1, 1, "2022-05-11", "2022-05-10", "가지", 1, Storage.Fridge, 9)
    }
