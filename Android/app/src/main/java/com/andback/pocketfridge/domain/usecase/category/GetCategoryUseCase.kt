...
class GetCategoryUseCase @Inject constructor(
    ...
    fun getMainCategory(): Observable<BaseResponse<List<MainCategoryEntity>>> = categoryRepository.getMainCategory()
    fun getSubCategory(): Observable<BaseResponse<List<SubCategoryEntity>>> = categoryRepository.getSubCategory()
    fun getAllCategories(): Observable<BaseResponse<List<Any>>> {
        return Observable.merge(getMainCategory(), getSubCategory())
    }
}